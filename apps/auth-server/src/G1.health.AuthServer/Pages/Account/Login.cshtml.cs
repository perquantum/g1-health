...
public class LoginModel : AccountPageModel
{
    ...
    public virtual async Task<IActionResult> OnGetAsync()
    {
        ...
        UserNameOrEmailAddress = L["UserNameOrEmailAddress"];
    ...
    public virtual async Task<IActionResult> OnPostAsync(string action)
    {
        ...
        var loginUser = await UserManager.FindByNameAsync(LoginInput.UserNameOrEmailAddress);
        var result = Microsoft.AspNetCore.Identity.SignInResult.Failed;
        if (loginUser != null)
        {
            result = await SignInManager.PasswordSignInAsync(loginUser, LoginInput.Password, LoginInput.RememberMe, true);
        }
