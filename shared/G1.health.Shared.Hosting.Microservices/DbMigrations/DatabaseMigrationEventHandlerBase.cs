...
namespace G1.health.Shared.Hosting.Microservices.DbMigrations;
    ...
    where TDbContext : DbContext, IEfCoreDbContext
{
    ...
    protected virtual int GetEventMessageTryCount(EtoBase eventData)
    {
        return IncrementEventTryCount(eventData);
    }
